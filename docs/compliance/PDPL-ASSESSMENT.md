...
- Since 2026-09-25 (item 41, owner decision) an approved update whose GPS point the salesman typed in by hand also carries the salesman's free-text reason into `AuditLog.after`. It is employee-authored and may name people, and it is as immutable as the rest of the ledger.
